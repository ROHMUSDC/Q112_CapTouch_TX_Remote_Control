...
CFILE 0000H 000003C3H "main\\main.c"
...
;;GPIO_17 ^= 1;
CLINEA 0000H 0001H 0116H 0001H 000DH
	tb	0f260h.0
	beq	_$M1
	rb	0f260h.0
	bal	_$M2
...
;;NOP1000();
CLINEA 0000H 0001H 0119H 0001H 000AH
	bl	_NOP1000
...
;;}//end main
CLINEA 0000H 0001H 011FH 0001H 000BH
CBLOCKEND 141 1 287
CFUNCTIONEND 141
...
;;	do {
CLINEA 0000H 0001H 013CH 0002H 0005H
_$L16 :
CBLOCK 124 3 316

;;		WDTCON = 0x5Au;
CLINEA 0000H 0001H 013DH 0003H 0011H
	mov	r0,	#05ah
	st	r0,	0f00eh
CBLOCKEND 124 3 318

;;	} while (WDP != 1);
CLINEA 0000H 0000H 013EH 0002H 0014H
	tb	0f00eh.0
	beq	_$L16

;;	WDTCON = 0xA5u;
CLINEA 0000H 0001H 013FH 0002H 0010H
	mov	r0,	#0a5h
	st	r0,	0f00eh
CBLOCKEND 124 2 320
...
CLINEA 0000H 0001H 014BH 0001H 0017H
	mov	er4,	#0 

;;	while(ONCNT < 60000) {	// NOP for 1000 Cycles
CLINEA 0000H 0001H 014DH 0002H 002EH
	bal	_$L19
_$L21 :
CBLOCK 140 3 333

;;		ONCNT++;
CLINEA 0000H 0000H 014EH 0003H 000AH
	add	er4,	#1 
CBLOCKEND 140 3 335

;;	}
CLINEA 0000H 0000H 014FH 0002H 0002H
_$L19 :

;;	while(ONCNT < 60000) {	// NOP for 1000 Cycles
CLINEA 0000H 0000H 014DH 0000H 0000H
	mov	er2,	#0 
	cmp	r4,	#060h
	cmpc	r5,	#0eah
	cmpc	r2,	#00h
...
CLINEA 0000H 0001H 016AH 0002H 003CH
	bl	_PortD_Low

;;    SetOSC();
CLINEA 0000H 0001H 016DH 0005H 000DH
	bl	_SetOSC

;;	TM8D    = 0;	//Timer 8 DATA Register
CLINEA 0000H 0001H 0174H 0002H 0025H
	mov	r0,	#00h
	st	r0,	0f8e0h

;;	TM8C    = 0;	//Timer 8 CLOCK Register
CLINEA 0000H 0001H 0176H 0002H 0026H
	st	r0,	0f8e1h

;;	T8C1 = 0;	// 01 = HTBCLK  
CLINEA 0000H 0001H 017AH 0002H 001BH
	rb	0f8e1h.1

;;	T8C0 = 1;
CLINEA 0000H 0001H 017BH 0002H 000AH
	sb	0f8e1h.0

;;	T89M16 = 0;	// 0=8-Bit Mode; 1=16bit Mode...
CLINEA 0000H 0001H 017DH 0002H 002DH
	rb	0f8e2h.5

;;	T8OST = 0;	// 0=Normal; 1=One-Shot...
CLINEA 0000H 0001H 017FH 0002H 0026H
	rb	0f8e2h.7

;;	T8RUN = 0;	//0=STOP; 1=START...
CLINEA 0000H 0001H 0182H 0002H 0020H
	rb	0f8e3h.0

;;	irq_di();	// Disable Interrupts
CLINEA 0000H 0001H 0189H 0002H 0020H
	bl	_irq_di

;;	irq_init();	// Initialize Interrupts (All Off and NO Requests)
CLINEA 0000H 0001H 018AH 0002H 003FH
	bl	_irq_init

;;	IE0 = IE1 = IE2 = IE3 = IE4 = IE5 = IE6 = IE7 = 0;
CLINEA 0000H 0001H 0195H 0002H 0033H
	mov	r0,	#00h
	st	r0,	0f017h
	st	r0,	0f016h
	st	r0,	0f015h
...
CLINEA 0000H 0001H 01A0H 0002H 003BH
	st	r0,	0f01fh
	st	r0,	0f01eh
	st	r0,	0f01dh
	st	r0,	0f01ch
...
CLINEA 0000H 0001H 01A1H 0002H 0046H
	rb	0f017h.3
...
CLINEA 0000H 0001H 01A4H 0002H 003CH
...
;;	QI2CM = 1;
CLINEA 0000H 0001H 01A7H 0002H 000BH
	sb	0f01ah.7

;;	EUA0 = 1; // EUA0 is the enable flag for the UART0 interrupt (1=ENABLED)
CLINEA 0000H 0001H 01A8H 0002H 0049H
	sb	0f014h.0

;;	irq_ei(); // Enable Interrupts
CLINEA 0000H 0001H 01AAH 0002H 001FH
	bl	_irq_ei
...
;;	HelloWorld[13] 	= 0x0A;
CLINEA 0000H 0001H 01B3H 0002H 0018H
	mov	r0,	#0ah
...
;;	InputStatus[22] 	= 0x0A;
CLINEA 0000H 0001H 01B5H 0002H 0019H
	mov	r0,	#0ah
...
;;	OutputRec[22] 	= 0x0A;
CLINEA 0000H 0001H 01B9H 0002H 0017H
	mov	r0,	#0ah
...
;;	NackMCUConn[61] = 0x0A;
CLINEA 0000H 0001H 01BDH 0002H 0018H
	mov	r0,	#0ah
...
;;	ListFWRev[21] = 0x0A;
CLINEA 0000H 0001H 01BFH 0002H 0016H
	mov	r0,	#0ah
...
;;	I2C_RX_REC[20] = 0x0A;
CLINEA 0000H 0001H 01C3H 0002H 0017H
	mov	r0,	#0ah
...
;;			     &_uartSetParam );				/* Param... 	 */
CLINEA 0000H 0001H 01D0H 0009H 002DH
...
;;	uart_PortSet();
CLINEA 0000H 0001H 01D1H 0002H 0010H
	bl	_uart_PortSet

;;	_flgUartFin = 0;
CLINEA 0000H 0001H 01D2H 0002H 0011H
	mov	r0,	#00h
	st	r0,	NEAR __flgUartFin

;;	uart_stop();
CLINEA 0000H 0001H 01D3H 0002H 000DH
	bl	_uart_stop

;;	uart_startSend(HelloWorld, 14, _funcUartFin); // Send, "Hello World!"
CLINEA 0000H 0001H 01D5H 0002H 0046H
...
;;	while(_flgUartFin != 1){
CLINEA 0000H 0000H 01D6H 0001H 0015H
	bal	_$L33

;;	while(_flgUartFin != 1){
CLINEA 0000H 0000H 01D6H 0002H 0019H
_$L27 :
CBLOCK 125 3 470

;;		NOP1000();
CLINEA 0000H 0001H 01D7H 0003H 000CH
	bl	_NOP1000

;;		main_clrWDT();
CLINEA 0000H 0001H 01D8H 0003H 0010H
	bl	_main_clrWDT
CBLOCKEND 125 3 473
...
CLINEA 0000H 0000H 01DFH 0001H 0015H
	bal	_$L34

;;	while(_flgI2CFin != 1){												//Wait for I2C commands to finish transfer
CLINEA 0000H 0000H 01DFH 0002H 004EH
_$L31 :
CBLOCK 125 4 479

;;		main_clrWDT();
CLINEA 0000H 0001H 01E0H 0003H 0010H
	bl	_main_clrWDT
CBLOCKEND 125 4 481
...
CLINEA 0000H 0001H 01E3H 0002H 001EH
	bl	_IRLED_PWM
CBLOCKEND 125 2 485
...
CLINEA 0000H 0001H 0201H 0002H 0053H
	bl	_i2c_continue

;;	_flgI2CFin = (unsigned char)FLG_SET;
CLINEA 0000H 0001H 0202H 0002H 0025H
	mov	r0,	#01h
	st	r0,	NEAR __flgI2CFin

;;	main_reqNotHalt();				// uncommented 5/2/2013
CLINEA 0000H 0001H 0203H 0002H 002EH
	bl	_main_reqNotHalt
CBLOCKEND 135 2 516
...
;;	(void)i2c_continue();
CLINEA 0000H 0001H 020FH 0002H 0016H
	bl	_i2c_continue

;;	main_reqNotHalt();
CLINEA 0000H 0001H 0210H 0002H 0013H
	bl	_main_reqNotHalt
CBLOCKEND 139 2 529
...
;;	while (ret != 1) {
CLINEA 0000H 0000H 0220H 0002H 0013H
_$L41 :
CBLOCK 136 3 544

;;		ret = i2c_continue();
CLINEA 0000H 0000H 0221H 0003H 0017H
	bl	_i2c_continue
CBLOCK 136 4 546
CBLOCKEND 136 4 548
CBLOCKEND 136 3 549
...
;;	while (ret != 1) {
CLINEA 0000H 0000H 0220H 0000H 0000H
	cmp	r0,	#01h
	cmpc	r1,	#00h
	bne	_$L41
CBLOCKEND 136 2 550
...
CLINEA 0000H 0001H 0231H 0002H 0026H
	mov	r0,	#01h
...
CLINEA 0000H 0001H 023DH 0003H 0047H
	b	_uart_continue
CBLOCKEND 138 2 574
...
CLINEA 0000H 0001H 0243H 0001H 0019H
CBLOCK 126 2 579

;;	SYSC0 = 0;			// Used to select the frequency of the HSCLK => 00=8.192MHz.
CLINEA 0000H 0001H 0246H 0002H 004AH
	rb	0f002h.0

;;	SYSC1 = 0;
CLINEA 0000H 0001H 0247H 0002H 000BH
	rb	0f002h.1

;;	OSCM1 = 1;			// 10 => Built-in PLL oscillation mode
CLINEA 0000H 0001H 0249H 0002H 0034H
	sb	0f002h.3

;;	OSCM0 = 0;
CLINEA 0000H 0001H 024AH 0002H 000BH
	rb	0f002h.2
...
CLINEA 0000H 0001H 024DH 0002H 0022H
	sb	0f003h.0

;;	LPLL = 1;			//1=Enables the use of PLL oscillation - ADDED 4/30/2013
CLINEA 0000H 0001H 024FH 0002H 0045H
	sb	0f003h.7

;;	__EI();			//INT enable
CLINEA 0000H 0001H 0251H 0002H 0017H
	ei
CBLOCKEND 126 2 594
...
CLINEA 0000H 0001H 0259H 0001H 001DH
CBLOCK 127 2 601

;;	CMP0EN  = 0x01; 	// Comparator ON...
CLINEA 0000H 0001H 026FH 0002H 0025H
	sb	0f950h.0

;;	CMP0E1  = 0x00; 	// No Interupt...
CLINEA 0000H 0001H 0270H 0002H 0023H
	rb	0f951h.1

;;	CMP0E0  = 0x00;
CLINEA 0000H 0001H 0271H 0002H 0010H
	rb	0f951h.0

;;	CMP0SM1 = 0x00; 	// Detect without Sampling... 
CLINEA 0000H 0001H 0272H 0002H 0030H
	rb	0f951h.3

;;	CMP0RFS = 0x01; 	// Differential Input on B5
CLINEA 0000H 0001H 0273H 0002H 002DH
	sb	0f951h.4

;;	CMP0EN  = 0x00;
CLINEA 0000H 0001H 0276H 0002H 0010H
	rb	0f950h.0
CBLOCKEND 127 2 633
...
CLINEA 0000H 0001H 0298H 0002H 003CH
	rb	0f255h.0

;;	PA0MD0  = 0;	
CLINEA 0000H 0001H 0299H 0002H 000EH
	rb	0f254h.0

;;	PA1MD1  = 0;	// PortA Bit1 set to General Purpose Output...
CLINEA 0000H 0001H 029AH 0002H 003CH
	rb	0f255h.1

;;	PA1MD0  = 0;	
CLINEA 0000H 0001H 029BH 0002H 000EH
	rb	0f254h.1
...
CLINEA 0000H 0001H 02A2H 0002H 0021H
	rb	0f250h.2

;;	main_clrWDT(); 	// Clear WDT
CLINEA 0000H 0001H 02A4H 0002H 001DH
	b	_main_clrWDT
CBLOCKEND 128 2 678
...
;;void PortB_Low(void){
CLINEA 0000H 0001H 02ACH 0001H 0015H
CBLOCK 129 2 684
...
CLINEA 0000H 0001H 02C4H 0002H 0031H
	sb	0f25bh.2

;;	PB2C0  = 1;	
CLINEA 0000H 0001H 02C5H 0002H 000DH
	sb	0f25ah.2

;;	PB3C1  = 1;		// PortB Bit3 set to CMOS Output...
CLINEA 0000H 0001H 02C6H 0002H 0031H
	sb	0f25bh.3
...
;;	PB4C0  = 1;	
CLINEA 0000H 0001H 02C9H 0002H 000DH
	sb	0f25ah.4
...
;;	PB5C0  = 1;	
CLINEA 0000H 0001H 02CBH 0002H 000DH
	sb	0f25ah.5
...
;;	PB6C0  = 1;	
CLINEA 0000H 0001H 02CDH 0002H 000DH
	sb	0f25ah.6
...
;;	PB1MD0  = 0;	
CLINEA 0000H 0001H 02D5H 0002H 000EH
	rb	0f25ch.1

;;	PB2MD1  = 0;	// PortB Bit2 set to General Purpose Output...
CLINEA 0000H 0001H 02D6H 0002H 003CH
	rb	0f25dh.2

;;	PB2MD0  = 0;	
CLINEA 0000H 0001H 02D7H 0002H 000EH
	rb	0f25ch.2

;;	PB3MD1  = 0;	// PortB Bit3 set to General Purpose Output...
CLINEA 0000H 0001H 02D8H 0002H 003CH
	rb	0f25dh.3
...
CLINEA 0000H 0001H 02DAH 0002H 003CH
	rb	0f25dh.4

;;	PB4MD0  = 0;	
CLINEA 0000H 0001H 02DBH 0002H 000EH
	rb	0f25ch.4

;;	PB5MD1  = 0;	// PortB Bit5 set to General Purpose Output...
CLINEA 0000H 0001H 02DCH 0002H 003CH
	rb	0f25dh.5
...
CLINEA 0000H 0001H 02DEH 0002H 003CH
	rb	0f25dh.6

;;	PB6MD0  = 0;	
CLINEA 0000H 0001H 02DFH 0002H 000EH
	rb	0f25ch.6
...
CLINEA 0000H 0001H 02E6H 0002H 0022H
	rb	0f258h.2
...
;;	main_clrWDT(); 	// Clear WDT
CLINEA 0000H 0001H 02EDH 0002H 001DH
	b	_main_clrWDT
CBLOCKEND 129 2 751
CLINEA 0000H 0001H 02EFH 0001H 0001H
CBLOCKEND 129 1 751
CFUNCTIONEND 129
...
;;void PortC_Low(void){
CLINEA 0000H 0001H 02F5H 0001H 0015H
CBLOCK 130 2 757
...
CLINEA 0000H 0001H 030FH 0002H 003BH
	sb	0f263h.3
...
CLINEA 0000H 0001H 0311H 0002H 003BH
	sb	0f263h.4
...
CLINEA 0000H 0001H 0313H 0002H 003BH
	sb	0f263h.5

;;	PC5C0  = 1;	
CLINEA 0000H 0001H 0314H 0002H 000DH
	sb	0f262h.5

;;	PC6C1  = 1;		// PortC Bit6 set to High-Impedance Output...
CLINEA 0000H 0001H 0315H 0002H 003BH
	sb	0f263h.6

;;	PC6C0  = 1;	
CLINEA 0000H 0001H 0316H 0002H 000DH
	sb	0f262h.6

;;	PC7C1  = 1;		// PortC Bit7 set to High-Impedance Output...
CLINEA 0000H 0001H 0317H 0002H 003BH
	sb	0f263h.7
...
CLINEA 0000H 0001H 0325H 0002H 003CH
	rb	0f265h.5
...
CLINEA 0000H 0001H 0327H 0002H 003CH
	rb	0f265h.6
...
CLINEA 0000H 0001H 0334H 0002H 0021H
	rb	0f260h.7

;;	main_clrWDT(); 	// Clear WDT
CLINEA 0000H 0001H 0336H 0002H 001DH
	b	_main_clrWDT
CBLOCKEND 130 2 824
...
;;void PortD_Low(void){
CLINEA 0000H 0001H 033EH 0001H 0015H
CBLOCK 131 2 830
...
CLINEA 0000H 0001H 034FH 0002H 002FH
	sb	0f26bh.0

;;	PD0C0= 1;		
CLINEA 0000H 0001H 0350H 0002H 000CH
	sb	0f26ah.0

;;	PD1C1= 1;		// PortD Bit1 set to CMOS Output...
CLINEA 0000H 0001H 0351H 0002H 002FH
	sb	0f26bh.1

;;	PD1C0= 1;	
CLINEA 0000H 0001H 0352H 0002H 000BH
	sb	0f26ah.1

;;	PD2C1= 1;		// PortD Bit2 set to CMOS Output...
CLINEA 0000H 0001H 0353H 0002H 002FH
	sb	0f26bh.2

;;	PD2C0= 1;	
CLINEA 0000H 0001H 0354H 0002H 000BH
	sb	0f26ah.2

;;	PD3C1= 1;		// PortD Bit3 set to CMOS Output...
CLINEA 0000H 0001H 0355H 0002H 002FH
	sb	0f26bh.3

;;	PD3C0= 1;		
CLINEA 0000H 0001H 0356H 0002H 000CH
	sb	0f26ah.3

;;	PD4C1= 1;		// PortD Bit4 set to CMOS Output...
CLINEA 0000H 0001H 0357H 0002H 002FH
	sb	0f26bh.4

;;	PD4C0= 1;	
CLINEA 0000H 0001H 0358H 0002H 000BH
	sb	0f26ah.4

;;	PD5C1= 1;		// PortD Bit5 set to CMOS Output...
CLINEA 0000H 0001H 0359H 0002H 002FH
	sb	0f26bh.5

;;	PD5C0= 1;	
CLINEA 0000H 0001H 035AH 0002H 000BH
	sb	0f26ah.5
...
CLINEA 0000H 0001H 0362H 0002H 0021H
	rb	0f268h.5

;;	main_clrWDT(); 	// Clear WDT
CLINEA 0000H 0001H 0365H 0002H 001DH
	b	_main_clrWDT
CBLOCKEND 131 2 871
CLINEA 0000H 0001H 0367H 0001H 0001H
CBLOCKEND 131 1 871
CFUNCTIONEND 131
...
CLINEA 0000H 0001H 036DH 0001H 0020H
CBLOCK 132 2 877
...
CLINEA 0000H 0001H 0379H 0002H 0030H
	sb	0f251h.2

;;	PA0C1  = 1;		// PortA Bit0 set to Input with Pull-Up Resistor...
CLINEA 0000H 0001H 037DH 0002H 0041H
	sb	0f253h.0
...
CLINEA 0000H 0001H 037FH 0002H 0041H
	sb	0f253h.1
...
CLINEA 0000H 0001H 0381H 0002H 0041H
	sb	0f253h.2

;;	PA2C0  = 0;	
CLINEA 0000H 0001H 0382H 0002H 000DH
	rb	0f252h.2

;;	PA0MD1  = 0;	// PortA Bit0 set to General Purpose I/O...
CLINEA 0000H 0001H 0385H 0002H 0039H
	rb	0f255h.0
...
CLINEA 0000H 0001H 0387H 0002H 0039H
	rb	0f255h.1

;;	PA1MD0  = 0;	
CLINEA 0000H 0001H 0388H 0002H 000EH
	rb	0f254h.1

;;	PA2MD1  = 0;	// PortA Bit2 set to General Purpose I/O...
CLINEA 0000H 0001H 0389H 0002H 0039H
	rb	0f255h.2
...
;;	main_clrWDT(); 	// Clear WDT
CLINEA 0000H 0001H 038CH 0002H 001DH
	b	_main_clrWDT
CBLOCKEND 132 2 910
...
;;void IRLED_PWM(void){
CLINEA 0000H 0001H 0396H 0001H 0015H
CBLOCK 133 2 918

;;	PF1EN = 1;		//The PF2EN, PF1EN, and PF0EN are output enable bits of PWMF0 to 2
CLINEA 0000H 0001H 03A1H 0002H 004FH
	sb	0f976h.5
...
CLINEA 0000H 0001H 03A7H 0002H 0031H
	sb	0f263h.1

;;	PC1C0  = 1;		
CLINEA 0000H 0001H 03A8H 0002H 000EH
	sb	0f262h.1

;;	PC1MD1  = 1;	// PortC Bit1 set to PWMF1 Output (1,0)...
CLINEA 0000H 0001H 03ABH 0002H 0038H
	sb	0f265h.1

;;	PC1MD0  = 0;	
CLINEA 0000H 0001H 03ACH 0002H 000EH
	rb	0f264h.1

;;	PFCS1 = 0;	//00= LS; 01=HS; 10=PLL
CLINEA 0000H 0001H 03AFH 0002H 0023H
	rb	0f972h.1

;;	PFCS0 = 1;
CLINEA 0000H 0001H 03B0H 0002H 000BH
	sb	0f972h.0

;;	PWFP = 4250;		// Init Period to (1=255kHz; 10=46kHz; 50=10kHz; 200=2.5kH; ; 3185 = 160Hz; 3400=150Hz; 4250=120Hz; 5000=102Hz)
CLINEA 0000H 0001H 03B4H 0002H 007EH
	mov	r0,	#09ah
	mov	r1,	#010h
	st	er0,	0f960h

;;	PWF1ED =  12;		//12    ~  0.25 % duty cycle @ 160Hz
CLINEA 0000H 0001H 03BEH 0002H 0034H
	mov	er0,	#12
	st	er0,	0f964h

;;	PFRUN = 1;			// Turn ON
CLINEA 0000H 0001H 03C0H 0002H 0018H
	sb	0f973h.0
CBLOCKEND 133 2 962
